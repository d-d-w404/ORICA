...
from paths import REPO_ROOT, TEMP_TXT_ROOT
...
print("initialize")
data = np.load(TEMP_TXT_ROOT / "orica_mats_20250915_040207.npz")
W = data["icaweights"]
...
print("initialize")
data = scipy.io.loadmat(TEMP_TXT_ROOT / "cleaned_data_20251001_163725.mat")
