...
def main():
    ...
    #raw
    #subject_id = "s05_061019m_new_ref"
    
    # 自动映射：取 subject_id 前两位拼到 b 后，例如 "s1_resampled" -> "bs1"
    file_tag = f"b{subject_id[:3]}"
    asr_calib_npz = str(
        INPUT_DATA_ROOT
        / "asr_cali/Shawn_shared/2min"
        / f"{subject_id}.npz"
    )
    ...
    raw_experiments = [
        ...
        {"method": "4", "save_dir": "output_data/xxSN_Driveasrpy20_2min_70", "asr_cutoff": "20", "icalabel_threshold": "0.7"},
